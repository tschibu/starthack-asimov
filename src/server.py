...
async def crash_image(request):
    ...
    angle_impact, max_force, damage_id, crash_time, max_force_offset = DataParser().parse_input_data(
        request.body.decode('utf8'))
    d = Drawer(angle_impact, max_force, damage_id, crash_time, max_force_offset)
